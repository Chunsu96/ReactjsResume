...
import logo from '../images/about/default-avatar.jpg';
import {
            ...
            <div style={{ padding: "15px" }}>
                <Row>
                    ...
                    <Col md={3} className="center-mobile-text">
                        ...
                        <a style={{ color: "#007bb5" }} target="_blank" href="https://www.linkedin.com/in/alvin-sung-005668162/">
                            <span className="fa-stack fa-lg">
                                <i className="fas fa-circle fa-stack-2x"></i>
                                <i className="fab fa-linkedin-in fa-stack-1x fa-inverse"></i>
                            </span>
                        </a>
                        <a style={{ color: "black" }} target="_blank" href="https://github.com/Chunsu96?tab=repositories">
                            <span className="fa-stack fa-lg">
                                <i className="fas fa-circle fa-stack-2x"></i>
                                <i className="fab fa-github fa-stack-1x fa-inverse"></i>
                            </span>
                        </a>
                        <a style={{ color: "red" }} target="_blank" href="mailto:alvin.sung@googlemail.com">
                            <span className="fa-stack fa-lg">
                                <i className="fas fa-circle fa-stack-2x"></i>
